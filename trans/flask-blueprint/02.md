...
虽然简单，但一旦应用程序的复杂性增加，这种方法的缺点就会变得明显：
...
请注意，我们需要在实例化应用程序对象后导入视图，否则将创建循环导入。一旦我们开始使用蓝图开发应用程序，我们通常会通过确保一个蓝图不会从另一个蓝图导入来避免循环导入。
...
![Our first blueprint](graphics/3965_02_01.jpg)
