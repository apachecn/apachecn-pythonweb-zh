...
![Enter the admin site](graphics/image_05_001.jpg)

图 5.1:**Django 管理员**登录界面

![Enter the admin site](graphics/image_05_002.jpg)

图 5.2:**Django 管理员**主页

Django 管理站点中的每种类型的数据都有一个更改列表和一个编辑表单。更改列表显示数据库中的所有可用对象，编辑表单允许添加、更改或删除数据库中的特定记录。点击**用户**行中的**变更**链接，加载用户变更列表页面（*图 5.3*。

![Enter the admin site](graphics/image_05_003.jpg)
...
![Enter the admin site](graphics/image_05_004.jpg)
...
![Enter the admin site](graphics/image_05_005.jpg)

图 5.5：显示错误的编辑表单

![Enter the admin site](graphics/image_05_006.jpg)
...
![Customizing change lists](graphics/image_05_007.jpg)
...
![Customizing change lists](graphics/image_05_008.jpg)
...
![Customizing change lists](graphics/image_05_009.jpg)
 ...
 ******![Customizing change lists](graphics/image_05_010.jpg)
...
![Customizing change lists](graphics/image_05_011.jpg)
...
![Customizing change lists](graphics/image_05_012.jpg)
...
![Customizing edit forms](graphics/image_05_013.jpg)
...
![Customizing edit forms](graphics/image_05_014.jpg)
