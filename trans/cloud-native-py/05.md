...
如果您现在加载页面，它将非常简单。因为我们想要创建一个 web 应用程序，它应该是有吸引力的，所以我们将在这里使用一些 CSS 来实现这一点。在我们的例子中，我们使用的是物化 CSS（[http://materializecss.com/getting-started.html](http://materializecss.com/getting-started.html) ）。
