...
没有什么我们以前没见过的。在这里，我们有一个表单，通过调用我们应用程序的`/add`功能将数据添加到我们的数据库中，在它的正下方，我们循环遍历所有现有数据，并在`<p>`标记中显示每一块数据。
...
![Running the code on our VPS](graphics/B04312_06_01.jpg)
...
![Injecting SQL into our database application](graphics/B04312_06_02.jpg)
...
![Injecting SQL into our database application](graphics/B04312_06_03.jpg)
...
![Mitigating against SQL injection](graphics/B04312_06_04.jpg)
