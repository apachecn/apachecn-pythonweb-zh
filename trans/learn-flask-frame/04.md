...
![The create.html template](images/1709_04_01.jpg)

尝试提交表单。当您点击**创建**按钮时，您会看到以下错误消息：

![The create.html template](images/1709_04_02.jpg)
...
![Handling form submissions](images/1709_04_03.jpg)
...
![Validating input and displaying error messages](images/1709_04_04.jpg)
...
![Displaying flash messages in the template](images/1709_04_05.jpg)
...
![Saving and modifying tags on posts](images/1709_04_06.jpg)
...
继续尝试图像上传器。您应该会在应用程序的`static/images/directory`中看到您上传的文件。您还可以通过导航到`http://127.0.0.1:5000/static/images/the-file-name.jpg`在浏览器中查看图像。
