...
在本节中，我们将部署我们在前几章中开发的云本机应用程序。但是，在开始创建应用程序体系结构之前，我们应该了解 Docker 的一些概念，其中一些概念如下：
...
接下来，检查应用程序 URL（`http://your-master-ip-address:5000/`。如果您看到以下屏幕，这意味着我们的应用程序已成功部署，并且我们在 Docker 上处于活动状态：
