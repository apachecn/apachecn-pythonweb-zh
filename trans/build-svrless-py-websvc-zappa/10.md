...
如前所述，您还可以使用应用级 CORS。有很多库可用于集成 CORS，一些框架有很好的库，例如`django-cors-headers`（[https://github.com/ottoyiu/django-cors-headers](https://github.com/ottoyiu/django-cors-headers) 和Flask CORS（[https://github.com/corydolphin/flask-cors](https://github.com/corydolphin/flask-cors) ）。
