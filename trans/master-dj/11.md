...
![Creating users](graphics/image_11_001.jpg)
...
![Creating users](graphics/image_11_002.jpg)
...
![Changing passwords](graphics/image_11_003.jpg)

图 11.3：更改密码的链接（圆圈）

单击链接后，您将进入更改密码表单（*图 11.4*。

![Changing passwords](graphics/image_11_004.jpg)
